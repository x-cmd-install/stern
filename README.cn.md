...
[![x-cmd/install — stern Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/stern.svg?lang=zh)](https://x-cmd.com/install/stern)
...
合计: **5,725** 行代码（覆盖前 5 种语言、共 **42** 个文件）。
...
- **Star**: 4,871 · **Fork**: 177 · **开放 issue**: 157 · **贡献者**: 60

## 累计统计

- **发布数**: 27 · **已合并 PR**: 187 · **开放 PR**: 9 · **已关闭 issue**: 127 · **开放 issue**: 30 · **提交数**: 320

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 0 | 1 | 0 | 0 | 2 |
| last60d | 2026-07-27 | 0 | 3 | 2 | 1 | 0 | 3 |
| 90d | 2026-06-27 | 0 | 3 | 5 | 1 | 0 | 4 |
| last180d | 2026-03-29 | 1 | 12 | 6 | 2 | 0 | 12 |
| 360d | 2025-09-30 | 2 | 15 | 7 | 3 | 3 | 15 |
| last720d | 2024-10-05 | 5 | 30 | 9 | 12 | 11 | 31 |
...
_数据快照: `data/card/260925.yml` · 2026-09-25T05:10:57Z._
